...
//    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        if let vid = self.selectedVideo {
            ...
            let videoEmbedString = "<html><head><style type=\"text/css\">body {background-color: transparent;color: white;}</style></head><body style=\"margin:0\"><iframe frameBorder=\"0\" height=\"\(view.frame.width*0.7)\" width=\"\(view.frame.width)\" src=\"http://www.youtube.com/embed/" + vid.id + "?showinfo=0&modestbranding=1&frameborder=0&rel=0\"></iframe></body></html>"
